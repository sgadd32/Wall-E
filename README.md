...
-------------------------------------------------------------------------------------------------------------------------------------------
NOTE:
I thought that the currrent SSD image contained the language options in the interface for Wall-E's voice already including multi dialects but after all these years I just realised that they were set to only Greek and Australian!? So I've now referenced the following snipet of where to edit the different language options : under /home/pi/walle-replica/web_interface/  <img width="1488" height="929" alt="image" src="https://github.com/user-attachments/assets/d6c7f270-1817-4a01-b2b3-4b9316c69902" />
