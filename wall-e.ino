...
//   POT_DIV = R2 / (R1 + R2)
//   For example: 50000 / (100000 + 50000) = 0.3333
//
// To enable battery level detection, uncomment(//) the next line:
#define BAT_L A2 			// Battery level detection analogue pin
#ifdef BAT_L
	#define BAT_MAX 16.70  // Maximum voltage
	#define BAT_MIN 12.10   // Minimum voltage
	#define POT_DIV 0.3333 // Potential divider scaling factor
#endif
...
int preset[][2] =  {{608,362},  // head rotation
                    ...
                    {600,375},  // arm left
                    {428,600}, // arm right
                    {180,430},  // eyebrow left
                    {355,185}}; // eyebrow right
...
float curpos[] = { 608, 475, 140, 475, 260, 600, 428, 180, 355, 180, 180};  // Current position (units)
float setpos[] = { 608, 475, 140, 475, 260, 600, 428, 180, 355,   0,   0};  // Required position (units)
